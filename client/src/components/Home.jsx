  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-primary/10 to-background pt-24 pb-32">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 opacity-50 pointer-events-none z-0">
          <div className="w-[500px] h-[500px] rounded-full bg-primary/5 blur-3xl"></div>
        </div>

        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-5xl sm:text-6xl font-bold tracking-tight mb-6 bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button
                size="lg"
                className="text-lg h-12 px-8 hover:bg-primary/90 transition-colors"
                asChild
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <Link
              ...
              className={`group rounded-xl p-6 ${category.color} hover:scale-105 transition-transform duration-200`}
            >
